...
| `GOOGLE_DRIVE_MATERIALS_ROOT_FOLDER_ID` | ID thư mục `HungTranPM - Lesson Materials` (tài nguyên đầu buổi + HTML overflow `LessonHtml/{programId}`). Thiếu biến này → upload tài nguyên / HTML lớn 502/503 |
